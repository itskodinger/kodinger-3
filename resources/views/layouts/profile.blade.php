        ...
        <div class="flex -mx-4 flex-col lg:flex-row">
            <div class="lg:w-3/12 px-4 lg:py-0 flex-shrink-0 w-full">
                <ul class="lg:sticky lg:top-0 flex lg:flex-col flex-row lg:py-12 mb-4 mt-6 -mx-3 lg:mx-0 md:flex-wrap flex-no-wrap overflow-x-auto">
                    <li><a class="relative md:text-base flex px-3 py-4 rounded {{ is_route('single', ' text-indigo-600 font-bold', 'hover:text-indigo-600 text-gray-600') }}" href="@route('single', $user->username)">
                    ...
                    <li><a class="md:text-base flex px-3 py-4 rounded {{ is_route('discuss', ' text-indigo-600 font-bold', 'hover:text-indigo-600 text-gray-600') }}" href="@route('discuss', $user->username)">
                    ...
                    <li><a class="md:text-base flex px-3 py-4 rounded {{ is_route('loves', ' text-indigo-600 font-bold', 'hover:text-indigo-600 text-gray-600') }}" href="@route('loves', $user->username)">
                        <svg class="md:w-6 w-4 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g data-name="Layer 2"><g data-name="heart"><rect width="24" height="24" opacity="0"/><path d="M12 21a1 1 0 0 1-.71-.29l-7.77-7.78a5.26 5.26 0 0 1 0-7.4 5.24 5.24 0 0 1 7.4 0L12 6.61l1.08-1.08a5.24 5.24 0 0 1 7.4 0 5.26 5.26 0 0 1 0 7.4l-7.77 7.78A1 1 0 0 1 12 21zM7.22 6a3.2 3.2 0 0 0-2.28.94 3.24 3.24 0 0 0 0 4.57L12 18.58l7.06-7.07a3.24 3.24 0 0 0 0-4.57 3.32 3.32 0 0 0-4.56 0l-1.79 1.8a1 1 0 0 1-1.42 0L9.5 6.94A3.2 3.2 0 0 0 7.22 6z"/></g></g></svg>
                        Disukai
                    </a></li>
                    @isme($user)
                    <li><a class="md:text-base flex px-3 py-4 rounded {{ is_route('saves', ' text-indigo-600 font-bold', 'hover:text-indigo-600 text-gray-600') }}" href="@route('saves')">
                        <svg class="md:w-6 w-4 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g data-name="Layer 2"><g data-name="bookmark"><rect width="24" height="24" opacity="0"/><path d="M6.09 21.06a1 1 0 0 1-1-1L4.94 5.4a2.26 2.26 0 0 1 2.18-2.35L16.71 3a2.27 2.27 0 0 1 2.23 2.31l.14 14.66a1 1 0 0 1-.49.87 1 1 0 0 1-1 0l-5.7-3.16-5.29 3.23a1.2 1.2 0 0 1-.51.15zm5.76-5.55a1.11 1.11 0 0 1 .5.12l4.71 2.61-.12-12.95c0-.2-.13-.34-.21-.33l-9.6.09c-.08 0-.19.13-.19.33l.12 12.9 4.28-2.63a1.06 1.06 0 0 1 .51-.14z"/></g></g></svg>
                        Disimpan
                    </a></li>
                    @endisme
                    <li><a class="md:text-base flex px-3 py-4 rounded {{ is_route('contributes', ' text-indigo-600 font-bold', 'hover:text-indigo-600 text-gray-600') }}" href="@route('contributes', $user->username)">
                    ...
                    @isme($user)
                    <li><a class="md:text-base flex px-3 py-4 rounded {{ is_route('setting', ' text-indigo-600 font-bold', 'hover:text-indigo-600 text-gray-600') }}" href="@route('setting')">
                ...
                <div class="relative overflow-hidden rounded border border-gray-200">
                    <div class="container mx-auto relative">
                        ...
                        <div class="absolute right-0 p-6">
                            <a href="@route('setting')" class="bg-white text-black text-sm py-1 px-3 rounded bg-gray-300 hover:bg-gray-400">Edit Profile</a>
                        </div>
                        @endisme
                        <div class="flex md:p-10 p-6 flex-col md:flex-row">
                            ...
                            <div class="md:ml-10 md:mt-0 mt-10">
                                ...
                                <p class="my-4 mb-5 text-gray-800 leading-relaxed">{!! $user->bio !!}</p>

                                <a href="{{ $user->github }}?ref=kodinger_profile" class="mt-4 bg-black hover:bg-transparent border border-black hover:text-black px-4 py-2 group inline-block rounded text-white items-center inline-flex">
