  ...
  @else
      <div class="border-b border-gray-200 px-6 md:px-12 pb-10 text-gray-600 text-center">
          <svg class="w-40 inline-block mb-6" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 609.98 593.41">
            ...
            <rect x="118.12" y="37.54" width="373.77" height="501.74" rx="35.02" fill="#5a67d8"/>
            ...
            <path d="M467,95.24V492.1a31.1,31.1,0,0,1-31.08,31.08H176.19a31.07,31.07,0,0,1-31.07-31.07h0V95.24a31.07,31.07,0,0,1,31.06-31.08H435.89A31.09,31.09,0,0,1,467,95.24Z" transform="translate(0 0)" fill="#5a67d8"/>
            ...
            <rect x="76.95" y="150.68" width="102.94" height="11.25" rx="5.62" fill="#5a67d8" opacity="0.32" style="isolation: isolate"/>
            <rect x="76.95" y="173.71" width="102.94" height="11.25" rx="5.62" fill="#5a67d8" opacity="0.32" style="isolation: isolate"/>
            <path d="M519,275.59h-91.7a5.63,5.63,0,0,1-5.63-5.62h0a5.62,5.62,0,0,1,5.62-5.62H519a5.62,5.62,0,0,1,5.62,5.62h0A5.62,5.62,0,0,1,519,275.59Z" transform="translate(0 0)" fill="#5a67d8" opacity="0.32" style="isolation: isolate"/>
            <path d="M519,298.62h-91.7a5.63,5.63,0,0,1-5.63-5.62h0a5.61,5.61,0,0,1,5.63-5.59H519a5.62,5.62,0,0,1,5.62,5.62h0A5.63,5.63,0,0,1,519,298.62Z" transform="translate(0 0)" fill="#5a67d8" opacity="0.32" style="isolation: isolate"/>
            <path d="M260.77,407.5H169.08a5.63,5.63,0,0,1-5.63-5.62h0a5.63,5.63,0,0,1,5.63-5.63h91.69a5.62,5.62,0,0,1,5.62,5.62h0a5.62,5.62,0,0,1-5.61,5.63Z" transform="translate(0 0)" fill="#5a67d8" opacity="0.32" style="isolation: isolate"/>
            <rect x="163.46" y="421.95" width="102.94" height="11.25" rx="5.62" fill="#5a67d8" opacity="0.32" style="isolation: isolate"/>
            <path d="M421.35,256.26a12,12,0,0,1-3.29,4.92c-2.79,2.55-6.33,4.15-9.08,6.74-6.1,5.74-7.11,14.91-7.75,23.26L399,320H357a40.86,40.86,0,0,0-8.95,1q.81-11.6,1.4-23.2c.74-14.53.77-30.51-8.49-41.74a6.57,6.57,0,0,1-1.9-3.39c-.12-1.49.89-2.81,1.84-4,.06-.06.1-.12.16-.19l6.18-7.55a4.45,4.45,0,0,1,2.82-2,4,4,0,0,1,2.67,1.26,50.94,50.94,0,0,1,6.48,7.13c1.27,1.6,2.51,3.22,3.83,4.78,6.23,7.36,15.74,12.54,24.72,6.64A176.68,176.68,0,0,1,407,247.41a96.56,96.56,0,0,1,9.51-4c-.19,1.55.64,2.81,1.67,4a20.51,20.51,0,0,1,2.9,3.73A6.69,6.69,0,0,1,421.35,256.26Z" transform="translate(0 0)" fill="#5a67d8"/>
            ...
            <circle cx="190.72" cy="296.3" r="7.87" fill="#5a67d8"/>
            <circle cx="214.91" cy="296.3" r="7.87" fill="#5a67d8"/>
            <circle cx="239.1" cy="296.3" r="7.87" fill="#5a67d8"/>
            <circle cx="384.24" cy="429.82" r="7.87" fill="#5a67d8"/>
            <circle cx="408.42" cy="429.82" r="7.87" fill="#5a67d8"/>
            <circle cx="432.6" cy="429.82" r="7.87" fill="#5a67d8"/>
            <circle cx="352.18" cy="161.92" r="7.87" fill="#5a67d8"/>
            <circle cx="376.37" cy="161.92" r="7.87" fill="#5a67d8"/>
            <circle cx="400.55" cy="161.92" r="7.87" fill="#5a67d8"/>
