        ...
        <div class="flex mt-8 -mx-4">
            ...
            <div class="w-4/12 mx-4">
                <div class="bg-white rounded border border-gray-300 hover:border-indigo-600 px-4 py-8 text-center">
                    ...
                    <a href="{{ $team['website'] }}" class="text-xs mt-6 inline-block tracking-wider uppercase font-semibold bg-indigo-600 hover:bg-indigo-800 text-white py-1 px-3 rounded">Website</a>
                </div>
            </div>
            @endforeach
        </div>
