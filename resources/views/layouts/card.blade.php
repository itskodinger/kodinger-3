                    ...
                    @isset($discover)
                        ...
                        <div class="shimmer border rounded mx-6">
                            ...
                            <div class="p-4 border-t bg-gray-100">
                                <h2 class="text-lg font-semibold hover:text-indigo-600"><a href="{{ leave($props->pages) }}">@if($title instanceof \App\PostAttribute) {{$title->value}} @else {{ leave($url['host']) }} @endif</a></h2>
                    ...
                    <div class="p-6 text-sm text-gray-700 leading-loose">
                        ...
                        <div class="mt-8">
                            <div class="flex w-full">
                                ...
                                <a class="ml-2 w-12 h-12 hover:bg-gray-100 rounded-full text-gray-600 flex items-center justify-center border-2 border-gray-200" href="{{ leave(route('single', $props->slug)) }}#comments">
