                ...
                <div class="relative overflow-hidden rounded border border-gray-200">
                    <div class="container mx-auto relative">
                        ...
                        <div class="absolute right-0 p-6">
                            <a href="@route('setting')" class="bg-white text-black text-xs py-1 px-3 rounded bg-gray-300 hover:bg-gray-400">Edit Profile</a>
                        </div>
                        @endisme
                        <div class="flex md:p-10 p-6 flex-col md:flex-row">
                            ...
                            <div class="md:ml-10 md:mt-0 mt-10">
                                ...
                                <p class="text-sm my-4 mb-5 text-gray-800 leading-relaxed">{!! $user->bio !!}</p>

                                <a href="{{ $user->github }}?ref=kodinger_profile" class="mt-4 bg-black hover:bg-transparent border border-black hover:text-black px-4 py-2 group inline-block text-sm rounded text-white items-center inline-flex">
