            ...
            <div class="w-6/12 px-4">
                ...
                <form id="discover-form" autocomplete="off">
                    <div class="border-2 border-gray-200 rounded">
                        <div class="p-5">
                            <h1 class="text-indigo-600 mb-4 font-semibold">Berbagi dengan komunitas</h1>
                            <div class="focus-within:border-indigo-500 px-4 py-3 rounded border border-gray-200">
                                <textarea name="link" placeholder="Bagikan link artikel, video, e-book atau apapun yang kamu buat sendiri atau kamu temukan di sini" class="focus:outline-none w-full h-16 text-sm resize-none"></textarea>
                                <input type="text" name="tags[]" class="border-t mt-4 w-full focus:outline-none text-sm pt-2" placeholder="Pilih maksimal 5 tag">
                            </div>
                        </div>
