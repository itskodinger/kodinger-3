            ...
            <a href="@route('auth', 'github')" class="flex items-center justify-center bg-black py-3 px-4 rounded text-white text-sm shadow-lg hover:shadow-none hover:bg-indigo-700">
            ...
            <a href="@route('auth', 'google')" class="mt-4 flex items-center justify-center border border-indigo-600 py-3 px-4 rounded text-indigo-600 text-sm hover:bg-gray-200">
