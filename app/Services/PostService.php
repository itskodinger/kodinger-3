...
class PostService
{
	...
	{
		$posts = $user->lovePosts()->with($this->with('post', ['post']))->where('deleted_at', null)->paginate(10);	
	...
	{
		$posts = $user->savePosts()->with($this->with('post', ['post']))->where('deleted_at', null)->paginate(10);	
