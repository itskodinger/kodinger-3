    ...
    <div class="flex items-center">
        <div class="w-full">
            ...
            <div class="text-center">
                ...
                @if(isset($myposts))
                <p class="mt-2 leading-loose text-gray-600">{{ $user->name }}, belum ada kontribusi ke semua konten kamu.</p>
                @else
                <p class="mt-2 leading-loose text-gray-600">{{ $user->name }} belum pernah melakukan kontribusi.</p>
                @endif
            </div>
            @endforelse
