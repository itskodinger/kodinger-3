...
<div class="off-canvasify rightbar" id="rightbar">
    ...
    <div class="mx-auto p-4 sm:p-0 sm:mx-0 mb-8">
        ...
        <div class="bg-white rounded border border-gray-200">
            @if($post->type !== 'link')
            <a class="flex items-center hover:bg-gray-100 px-5 py-4 border-b border-gray-100" href="{{ edit_post_route($post) }}">
                <div class="text-gray-600 font-semibold truncate">Sunting</div>
            </a>
            @endif
            <a class="flex items-center hover:bg-gray-100 px-5 py-4" href="@route('deletePost', $post->slug)">
                <div class="text-red-600 font-semibold truncate">Hapus</div>
            </a>
        </div>
    </div>
    @endif
