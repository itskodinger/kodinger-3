                    ...
                    <div class="border border-gray-200 rounded">
                        <div class="p-5">
                            ...
                            <div class="focus-within:border-indigo-500 px-4 py-3 rounded border border-gray-200">
                                <input name="link" placeholder="Taruh tautan di sini (cth. https://kodinger.com/artikel)" class="focus:outline-none w-full text-sm resize-none input-link" autofocus="">
                        ...
                        <div class="p-4 border-t border-gray-200 flex items-center">
                            ...
                            <div class="ml-auto flex items-center flex-shrink-0">
                                ...
                                <button class="bg-indigo-600 text-white px-5 py-2 rounded text-sm hover:bg-indigo-700 publish-button">Publish</button>
                            </div>
                        </div>
                    </div>
                </form>
