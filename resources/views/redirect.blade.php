            ...
            <div class="w-6/12 px-6">
            	<form method="post" id="form">
	            	<div class="p-8 bg-white border border-gray-200 rounded">
	            		<div>
		            		<h4 class="text-lg font-bold text-gray-600 border-b border-gray-200 pb-4 mb-6">Mengalihkan</h4>
                            ...
                            <div class="flex items-center bg-gray-100 border border-gray-200 mb-8 p-3 rounded">
