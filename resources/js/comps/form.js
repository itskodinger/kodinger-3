			...
			<>
				...
				<div className="caption-modal overflow-y-auto fixed top-0 left-0 w-full h-full flex z-30 items-start justify-center hidden">
				    ...
				    <div className="p-10 my-0 md:my-10 sm:w-6/12 lg:w-6/12 md:w-8/12 w-full h-full md:h-auto bg-white relative md:rounded shadow-lg">
				        ...
				        <p className="text-gray-600 mt-2 leading-relaxed">Berikan deskripsi pada slide ini. Kamu dapat mengosongkan deskripsi bila tidak ada. <a href={routes.docs + '/create-content#captioning'} className="border-b border-indigo-600 text-indigo-600">Pelajari selengkapnya</a> tentang mengisi keterangan.</p>
				        <div className="mt-6 mb-5">
				        	<div className="flex">
				        		<button onClick={this.captionSwitch.bind(this, 'editor')} className="border-t border-l rounded-tl-lg px-4 py-2 border-gray-200">Editor</button>
				        		<button onClick={this.captionSwitch.bind(this, 'preview')} className="border-t border-l rounded-tr-lg border-r px-4 py-2 border-gray-200">Preview</button>
				        	</div>
				        	<div className="caption-editor">
					        	<textarea className="caption-area w-full border border-gray-200 h-64 rounded-br-lg rounded-bl-lg p-4"></textarea>
				        	</div>
				        	<div className="caption-preview p-4 hidden border-gray-200 border mb-2 rounded-bl-lg rounded-br-lg overflow-auto markdowned">
				        		Parsing ...
				        	</div>
				        ...
				        <button onClick={this.closeCaptionModal.bind(this)} className="bg-indigo-600 p-4 text-white font-semibold rounded shadow block w-full text-center" type="button">Simpan Perubahan</button>
				    </div>
				</div>
				            	...
				            	<>
				            		{ id &&
					            		...
					            		{ status.toUpperCase() == 'PUBLISH' ?
						            		<div className="py-4 px-6 mb-4 bg-teal-100 text-teal-600 border border-teal-200 rounded leading-loose">
						            		...
						            		:
						            		<div className="py-4 px-6 mb-4 bg-blue-100 text-blue-600 border border-blue-200 rounded leading-loose">
									...
									<div className="border border-gray-200 p-6 md:p-8 rounded">
								        ...
								        <p className="mb-4 mt-2 text-gray-600">{postData.description}</p>
										...
										{ id && (
											<>
												...
												{ this.isSlidePost() &&
													<div className="mt-6">
														<label className="mb-1 inline-block text-gray-600">Design Keyword <span className="text-sm">(Optional)</span></label>
									...
									<>
										{ this.isSlidePost() &&
											<div className="border border-gray-200 p-6 md:p-8 rounded mt-10">
										        ...
										        <p className="leading-relaxed mb-6 mt-2 text-gray-600">Kamu dapat mengunggah gambar atau video dalam satu konten yang sama. <a href={routes.docs + '/content#form-media'} className="text-indigo-600 border-b border-indigo-600" target="_blank">Pelajari selengkapnya</a> tentang media.</p>
												...
												<div className="mb-6">
													...
													{images.length > 0 && (
														<>
															<div className="mt-6 text-sm uppercase font-semibold tracking-wider mb-2 text-gray-600 flex">
										...
										{ this.isMarkdownPost() &&
											<>
												<div className="border border-gray-200 p-6 md:p-8 rounded mt-10">
											        ...
											        <p className="leading-relaxed mb-6 mt-2 text-gray-600">Tulis isi post yang ingin kamu sampaikan. Kamu dapat menggunakan format Markdown, <a href=""  target="_blank">pelajari selengkapnya</a>.</p>

					        			        	<div className="flex items-center mb-2 sticky" style={{top: '90px'}}>
					        			        		<button onClick={this.uploadContentImage.bind(this)} className="flex items-center bg-white border border-gray-300 hover:border-indigo-500 hover:text-indigo-500 px-4 py-2 rounded">
				        			        	...
				        			        	<div className="border border-gray-200 p-6 md:p-8 rounded mt-10">
				        			                ...
				        			                <p className="leading-relaxed mb-6 mt-2 text-gray-600">Bila dikosongkan, sistem akan otomatis menggenerasi thumbnail untuk post ini. Bila diisi, gambar akan otomatis dipotong oleh sistem bila dimensinya tidak 500 x 300 (Maksimal: 10MB. Format yang didukung: {[...this.allowedImageTypesReadable].join(', ')}).</p>
					        			        	...
					        			        	<div onClick={this.coverImageHandler.bind(this)} className={`group w-full border border-gray-300 rounded flex items-center justify-center cursor-pointer ${cover ? '' : 'h-64'}`}>
					        			        		...
					        			        		<div className="cover-image-label absolute bg-white border border-gray-300 group-hover:border-indigo-500 group-hover:text-indigo-500 px-3 py-2 rounded">{ cover ? 'Ganti Gambar' : 'Unggah Gambar'}</div>
					        			        	</div>
										        </div>
									        </>
									    }
									    ...
									    { this.isSlidePost() &&
											<div className="border border-gray-200 p-6 md:p-8 rounded mt-10">
										        <h2 className="text-indigo-600 mb-4 text-xl font-semibold">Tautan <span className="text-sm text-gray-600 font-normal">(Optional)</span></h2>
							            		...
							            		<div className="bg-gray-100 border border-gray-200 rounded p-4">
						            				...
						            				<div className="list">
						            					{ this.state[currentLinkKey].map((link, id) => {
								            				return (
								            					<div key={link.id} className="bg-white shadow rounded mb-4 text-blue-500 flex" id={'link-' + link.id}>
							            			...
							            			<button type="button" onClick={this.addLinkToKey.bind(this)} tabIndex="7" className="add-link-btn bg-white w-full shadow rounded py-3 px-4 text-blue-500 text-center cursor-pointer hover:bg-indigo-600 hover:text-white">Tambah URL</button>
							            		</div>
									        </div>
									    }
								        ...
								        { status.toUpperCase() == 'PUBLISH' &&
											<div className="border border-gray-200 p-6 md:p-8 rounded mt-10">
										        ...
										        <p className="leading-relaxed mb-6 mt-2 text-gray-600">Post ini sudah dipublikasikan dan semua orang dapat mengakses post ini melalui tautan, beranda, mesin pencari, atau cara lainnya. Kamu dapat mengubah status post ini menjadi "draft" untuk menyembunyikannya dari semua orang.</p>
