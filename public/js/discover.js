...
/* harmony import */ var _libs_post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./libs/post */ "./resources/js/libs/post.js");
...
/* harmony import */ var _utils_validate_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/validate-url */ "./resources/js/utils/validate-url.js");
...
/* harmony import */ var _comps_show_login_alert__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./comps/show-login-alert */ "./resources/js/comps/show-login-alert.js");
...
var posts = _libs_post__WEBPACK_IMPORTED_MODULE_1__["post"].init('.posts', {
  ...
  lazyimage: false,
  type: _libs_post__WEBPACK_IMPORTED_MODULE_1__["types"].DISCOVER
});
/**
 * Init Tagify library
 */

var tagify = new _yaireo_tagify__WEBPACK_IMPORTED_MODULE_2___default.a($('.tags'), {
...
$('#discover-form').addEventListener('submit', function (e) {
  ...
  if (link.value.trim().length < 1 || !Object(_utils_validate_url__WEBPACK_IMPORTED_MODULE_3__["default"])(link.value)) {
    link.focus();
    ...
    .then(function (res) {
      Object(_utils_removes__WEBPACK_IMPORTED_MODULE_5__["default"])(btn.classList, 'pointer-events-none opacity-50');
      btn.disabled = false;
      ...
      shimmer.dispose();
      if (error.status == 401) Object(_comps_show_login_alert__WEBPACK_IMPORTED_MODULE_6__["default"])();
    });
  }
...
/***/ 3:
/*!****************************************!*\
  !*** multi ./resources/js/discover.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/apple/Sites/kd/resources/js/discover.js */"./resources/js/discover.js");
