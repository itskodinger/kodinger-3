...
var tagSearchCollection = function tagSearchCollection(search) {
  ...
  var this_height = search.clientHeight,
      tpl = "\n\t\t<div class=\"absolute z-10 text-sm left-0 w-full bg-white tag-search-collection shadow-lg rounded\" style=\"top: ".concat(this_height + 10, "px;\">\n\t\t\t<div class=\"px-4 py-2\">Ketik min. 3 huruf</div>\n\t\t</div>");
...
module.exports = __webpack_require__(/*! /Library/WebServer/Documents/kd/resources/js/search.js */"./resources/js/search.js");
