							...
							<div className="border border-gray-200 p-6 md:p-8 rounded">
								...
								{ id && (
							        <>
								        ...
								        <div className="mb-6">
								        	<label className="mb-1 text-sm inline-block text-gray-600">Konten</label>
								        	<div className="flex items-center">
								        		<button onClick={this.uploadImage.bind(this)} className="flex items-center border border-gray-300 hover:border-indigo-500 hover:text-indigo-500 mb-2 px-4 py-2 rounded text-sm">
					        	        	...
					        	        	<div className="content-preview p-4 hidden border-gray-200 border mb-2 rounded text-sm overflow-auto markdowned">
					        	        		Parsing ...
					        	        	</div>
								        ...
								        <div>
								        	<label className="mb-1 text-sm inline-block text-gray-600">Thumbnail</label>
								        	<div className="text-sm mb-2 italic">Bila dikosongkan, sistem akan otomatis menggenerasi thumbnail untuk post ini. Bila diisi, gambar akan otomatis dipotong oleh sistem bila dimensinya tidak 500 x 300.</div>
								        	<div onClick={this.coverImageHandler.bind(this)} className="group w-full border border-gray-300 rounded flex items-center justify-center cursor-pointer h-64">
								        		<div className="cover-image-label absolute bg-white border border-gray-300 group-hover:border-indigo-500 group-hover:text-indigo-500 px-3 py-2 rounded text-sm">Unggah Gambar</div>
								        	</div>
								        </div>
							        </>
						        )}
